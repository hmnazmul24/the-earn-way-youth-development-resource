...
export const courseNameArr = [
  "Computer Office Application",
  "Database Programming",
  "Diploma in Computer Science",
  "Diploma in ICT",
  "Diploma in Multilingual Secretarial Science",
  "Graphics Design",
  "Higher Diploma in Computer Science",
  "Web Design & Development",
  "WordPress",
  "Diploma in Electric & Electronic Technology",
  "Diploma in Hardware",
  "Troubleshooting in Maintaining",
  "Spoken English",
  "Dress Making & Tailoring",
  "Diploma in Electric & House Wiring",
  "Digital Marketing",
